    ...
    <div className="w-10/12 ring-2 ring-jiinf-primary mx-auto bg-jiinf-lightskin text-white p-4 rounded-lg flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 mb-4 shadow-lg min-h-28 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row w-full items-center">
        ...
        <div className="flex text-xl font-semibold flex-col items-center justify-center w-full md:w-1/4 mb-4 md:mb-0">
          ...
          <p className=" text-jiinf-primary text-lg lg:text-xl">{game.desc}</p>
            <h3 className="text-3xl lg:text-4xl font-SuperDario font-bold text-jiinf-primary">{game.modalidade.toUpperCase()}</h3>
            <p className="text-xl font-semibold text-jiinf-primary">{game.naipe}</p>
          </div>
        </div>

        {/* Divider Horizontal para Telas Menores */}
        <div className="md:hidden w-full h-[1px] bg-jiinf-primary"></div>

        {/* Divider Vertical para Telas Maiores */}
        <div className="hidden md:block w-[1px] h-32 bg-jiinf-primary mx-4"></div>
        ...
        {/* Divider Horizontal para Telas Menores */}
        <div className="md:hidden w-full h-[1px] bg-jiinf-primary mt-4"></div>
        ...
        <div className="flex flex-col mt-2 items-center justify-center w-full md:w-1/4 text-center">
          ...
          <div className="text-md text-jiinf-primary font-bold">{dateLabel}</div>
